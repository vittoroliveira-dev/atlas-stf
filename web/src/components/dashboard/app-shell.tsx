...
const NAV_ITEMS = [
  ...
  { href: "/sancoes", label: "Sancoes administrativas", icon: AlertTriangle },
  { href: "/doacoes", label: "Doacoes eleitorais", icon: Banknote },
  { href: "/vinculos", label: "Vinculos empresariais", icon: Link2 },
  { href: "/afinidade", label: "Afinidade min.-adv.", icon: Users },
  { href: "/convergencia", label: "Sinais combinados", icon: Flame },
  { href: "/velocidade", label: "Velocidade decisoria", icon: Gauge },
  { href: "/redistribuicao", label: "Redistribuicao", icon: ArrowRightLeft },
  { href: "/representacao", label: "Representacao processual", icon: ShieldCheck },
  { href: "/rede-advogados", label: "Rede de advogados", icon: Network },
  { href: "/agenda", label: "Agenda ministerial", icon: Calendar },
  { href: "/temporal", label: "Analise temporal", icon: Clock3 },
