"""Match diagnostic functions for calibration harness.

Extracted from match_calibration.py to keep modules under 500 lines.
Pure analysis functions — no I/O, no checkpoints.
"""
